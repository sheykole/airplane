...
Hard way The best way to contribute is to "clone" your fork of CodeIgniter to your development state. That sounds like some jargon, but "forking" on GitHub means "making a copy of that repo to your account" and "cloning" means "copying that code to your environment so you can work on it".
